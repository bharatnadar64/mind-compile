...
const Footer = () => {
  return (
    <footer className="pt-3.5 relative bg-black text-green-400 font-mono overflow-hidden">
      ...
      <div className="w-full px-6 sm:px-10 lg:px-20 xl:px-32 py-16 lg:py-24 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-widest text-green-400 drop-shadow-[0_0_10px_#00ff00]">
              MINDCOMPILE
            </h2>
            ...
            <p className="text-green-500/50 text-xs sm:text-sm">
      ...
      {/* Side lines (adds structure on big screens) */}
